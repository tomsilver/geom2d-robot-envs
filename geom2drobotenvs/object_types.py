...
Geom2DType = Type("geom2d", ["x", "y", "theta", "is_static", "color_r", "color_g", "color_b"])
# Specific geom types.
RectangleType = Type("rectangle", Geom2DType.feature_names + ["width", "height"], parent=Geom2DType)
...
# is for that circle. The arm_prism is a distance between the center and the
# gripper. The vacuum_on is a bit for whether the vacuum is on.
CRVRobotType = Type("crv_robot", ["x", "y", "theta", "base_radius", "arm_prism", "vacuum_on"])